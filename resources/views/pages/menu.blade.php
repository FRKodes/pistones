...
@section('content')
	<div class="container-fluid inner-banner togo">
		<div class="inner-title menu"><img src="images/menu_to_go_new.svg" alt="menu to go Pistones Garage"></div>
	</div>

	<div class="container">
		<div class="row">
			<div class="menu-page-top">
				<div class="col-xs-6 col-sm-6 col-md-5 col-md-offset-1"><img class="zona-reparto" src="images/horario_zonareparto_new.svg" alt="horario zona reparto Pistones Garage"></div>
